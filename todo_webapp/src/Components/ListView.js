  ...
  return (
    <div className="container listview-sec d-flex flex-column align-items-center">
      <div className="col w-100 mt-4 ">
        ...
        <div className="row-6  w-50 mx-auto border border-1">
          <div className=" ">

          <button class="btn btn-red rounded-4 px-4 m-3">
          ...
          <div>
          <button class="btn btn-pink rounded-top px-4 ms-2">All</button>
          <button class="btn btn-pink rounded-top px-4 ms-2">High</button>
          <button class="btn btn-pink rounded-top px-4 ms-2">Medium</button>
          <button class="btn btn-pink rounded-top px-4 ms-2">Low</button>
          <button class="btn btn-pink rounded-top px-4 ms-2">Done</button>
